 ...
 * Use the {@link addminselection#newInstance} factory method to
...
public class addminselection extends Fragment {
     ...
     * @return A new instance of fragment addminselection.
     */
    // TODO: Rename and change types and number of parameters
    public static addminselection newInstance(String param1, String param2) {
        addminselection fragment = new addminselection();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        carsel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_addminselection_to_blankFragment2);
            }
        });
        bikesel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_addminselection_to_bikeupload);
            }
        });
        return  view;
    }
